...
function changePhone3(){
	...
	if(phone3.length === 4){
		...
		document.getElementById("sendMessage").setAttribute("style","background-color:#FFF; color:#0068FF; border-color:#0068FF;")
...
// 인증확인 버튼 활성화
document.getElementById("completion").setAttribute("style","background-color:#0068FF; color:#FFF;")
